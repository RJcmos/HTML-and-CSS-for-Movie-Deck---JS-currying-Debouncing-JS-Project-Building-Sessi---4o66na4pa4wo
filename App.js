...
async function fetchMovies(pageNo){
  ...
  //fetch('https://api.themoviedb.org/3/discover/movie?api_key=56b704fd69110b4a481c1482bd5b417c&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=1')
